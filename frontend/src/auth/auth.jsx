...
class Auth extends Component {
    constructor(props) {
        super(props)
        //Define o estado interno do objeto. Aqui a tela está no modo de login. Caso falso o modo será de cadastro
        this.state = { loginMode: true }
    }

    /**
     * Método que define o modo. Cadastro ou Login
     */
    changeMode() {
    ...
    /**
     * Modo submit que envia de acordo com o estado: Login ou Signup
     * @param {*} values 
     */
    onSubmit(values) {
...
//Não tem uso do redux, sendo assim não é necessário o mapStateToProps. 
